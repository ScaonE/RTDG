...
# Read initial FASTA (f2) & check intersection with viridi_hit_set &
# non_viridi_hit_set, we can deduce contigs with no hit from this intersection
cpt = 0
no_hit_set = set()
...
print('\t\t- number of seqs with non_plant_hit : ' + str(len(non_viridi_hit_set)))
